...
export const invesoraScoreSchema = z.object({
  ...
  breakdown: z.object({
    riskAdjustedReturn: scoreFactorBreakdownSchema,
    risk: scoreFactorBreakdownSchema,
    cost: scoreFactorBreakdownSchema,
    diversification: scoreFactorBreakdownSchema,
    fundSize: scoreFactorBreakdownSchema,
