...
| Lista de ETFs | [`/stable/etf-list`](https://site.financialmodelingprep.com/developer/docs/stable/etfs-list) | Poblar un universo inicial sin depender de simbolos escritos a mano. | Pendiente |
